        ...
        await database
            ...
            .insert(
              CachedMedicationsCompanion.insert(
                ...
                id: medication.id,
                mealRelation: Value(medication.mealRelation),
                profileId: profileId,
            ...
            .insertOnConflictUpdate(
              CachedPatientProfilesCompanion.insert(
                ...
                canReceiveMissedDoseAlerts: Value(
                  profile.canReceiveMissedDoseAlerts,
                ),
                canViewMedicationPlan: Value(profile.canViewMedicationPlan),
                displayName: profile.displayName,
                id: profile.id,
                missedDoseGraceMinutes: Value(profile.missedDoseGraceMinutes),
    ...
    return rows
        .map(
          (row) => PatientProfile(
            ...
            canReceiveMissedDoseAlerts: row.canReceiveMissedDoseAlerts,
            canViewMedicationPlan: row.canViewMedicationPlan,
            displayName: row.displayName,
            id: row.id,
            missedDoseGraceMinutes: row.missedDoseGraceMinutes,
